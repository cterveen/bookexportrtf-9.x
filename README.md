...
The project can be considered beta. The module is in use on a Drupal 11.x website using Book 1.0. The module has also been tested in Drupal 9.x and Drupal 11.x with Book 2.x test environments. Backwards compatibility with Book 1.x has not been tested. The coding has been updated to Drupal 9.x coding standards and includes testing. The RTF document was tested in Microsoft Word and Libreoffice Writer. The module is under active maintainance.
