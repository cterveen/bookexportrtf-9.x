...
The base language of the module is English. A Dutch translation of the interface and book parts is available. Timestamps generated by the module are formated according to the Drupal 'long' format. A help text is available (English only), options are not available. The module is not in the Drupal module repository.
